...
const mechanic_idRouter = require("./routes/mechanics_list")
const service_listRouter = require("./routes/service_list")
const service_requestsRouter = require("./routes/service_requests")
...
app.use("/mechanics_list" , mechanic_idRouter)
app.use("/service_list" , service_listRouter)
app.use("/service_requests" , service_requestsRouter)
